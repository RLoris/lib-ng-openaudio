...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsProjectsNgOpenaudioSrcLibNgOpenaudioComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function projectsNgOpenaudioSrcLibModelsEqualizerBarTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EqualizerBar", function () {
      return EqualizerBar;
    });
    /* harmony import */
    ...
    var EqualizerBar = function EqualizerBar(height) {
      _classCallCheck(this, EqualizerBar);
  ...
  /***/
  function projectsNgOpenaudioSrcLibModelsEqualizerStyleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EqualizerStyle", function () {
      return EqualizerStyle;
    });
    /* harmony import */
  ...
  /***/
  function projectsNgOpenaudioSrcLibModelsSongDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SongData", function () {
      return SongData;
    });
    /* harmony import */
    ...
    var SongData = function SongData() {
      _classCallCheck(this, SongData);
  ...
  /***/
  function projectsNgOpenaudioSrcLibModelsStatusEventTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StatusEvent", function () {
      return StatusEvent;
    });
    /* harmony import */
    ...
    var StatusEvent = function StatusEvent() {
  ...
  /***/
  function projectsNgOpenaudioSrcLibNgOpenaudioComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function projectsNgOpenaudioSrcLibNgOpenaudioComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NgOpenaudioComponent", function () {
      return NgOpenaudioComponent;
    });
    /* harmony import */
    ...
    var _models_equalizer_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./models/equalizer-bar */
    "./projects/ng-openaudio/src/lib/models/equalizer-bar.ts");
    /* harmony import */
    ...
    var _models_equalizer_style__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./models/equalizer-style */
    "./projects/ng-openaudio/src/lib/models/equalizer-style.ts");
    /* harmony import */


    var _models_status_event__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./models/status-event */
    "./projects/ng-openaudio/src/lib/models/status-event.ts");

    var NgOpenaudioComponent =
    /*#__PURE__*/
    function () {
      function NgOpenaudioComponent(sanitizer) {
        _classCallCheck(this, NgOpenaudioComponent);
        ...
        this.equalizerBar = [];
        this.progress = 0; // total duration
        ...
        try {
          ...
          this.visualStyles = Object.keys(_models_equalizer_style__WEBPACK_IMPORTED_MODULE_4__["EqualizerStyle"]).filter(function (key) {
            return isNaN(Number(_models_equalizer_style__WEBPACK_IMPORTED_MODULE_4__["EqualizerStyle"][key]));
          });
          this._visualStyle = this.visualStyles[this.visualStyleIdx];

          for (var index = 0; index < this._barAmount; index++) {
      ...
      _createClass(NgOpenaudioComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "triggerStatusEvent",
        value: function triggerStatusEvent(event) {
        ...
        key: "isCircularStyle",
        value: function isCircularStyle() {
        ...
        key: "isBarStyle",
        value: function isBarStyle() {
          if (this._visualStyle == "BARS_DOWN" || this._visualStyle == "BARS_UP" || this._visualStyle == "BARS_MIDDLE") {
            return true;
          } else {
            return false;
          }
        ...
        value: function loadSound(src) {
          ...
          try {
            ...
            this.audio.onloadedmetadata = function (d) {
              _this.duration = _this.audio.duration;

              _this.triggerStatusEvent('songLoaded');
            };

            this.audio.onvolumechange = function (v) {
              _this._volume = _this.audio.volume * 100;

              _this.triggerStatusEvent('volumeChanged');
            };

            this.audio.onended = function (v) {
              _this.audio.pause();
              ...
              _this.triggerStatusEvent('songEnded');
            };

            this.audio.onpause = function (v) {
              _this._isPlaying = !_this._isPlaying;
              _this.btnPlayPauseClass = 'controls-play-pause';
              clearInterval(_this.intervalId);

              _this.triggerStatusEvent('songPaused');
            };

            this.audio.onplay = function (v) {
              _this._isPlaying = !_this._isPlaying;
              _this.btnPlayPauseClass = 'controls-play-pause paused';
              ...
              _this.triggerStatusEvent('songPlayed');
            };

            this.audio.onseeking = function (v) {
              _this.updateProgress();

              _this.triggerStatusEvent('songProgressUpdated');
            };
          } catch (e) {
            this.errorEmitter.emit(e);
          }
        ...
        value: function startAnimation() {
          ...
          if (this.audio.src) {
            ...
            if (this._isPlaying === true) {
              ...
              this.equalizerBar.forEach(function (b) {
                b.transitionDuration = 2;
                b.height = 1;
              });
            }
          }
        ...
        value: function changeTime(event) {
          if (this.audio.src && this._controls === true) {
            var e = this.controlsProgressBar.nativeElement;
            var selection = event.x - e.offsetLeft; //@ts-ignore

            var jumpTo = selection / e.offsetWidth;
        ...
        value: function changeVolume(event) {
          if (this.audio.src && this._controls === true) {
            var e = this.controlsVolumeBar.nativeElement;
            var selection = event.x - e.offsetLeft; //@ts-ignore

            var volume = Math.round(selection / e.offsetWidth * 100);
        ...
        set: function set(v) {
          ...
          this.visualStyles.forEach(function (element, idx) {
            if (v === element) {
              _this3.visualStyleIdx = idx;
              _this3._visualStyle = v;
            }
          });
        },
        get: function get() {
        ...
        set: function set(v) {
          if (v >= 0 && v <= 100) {
            this.audio.volume = v / 100; // this._volume = v;
          }
        },
        get: function get() {
          return this._volume;
    ...
    NgOpenaudioComponent.ctorParameters = function () {
      return [{
        type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"]
      }];
    };

    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('errorsEvent')], NgOpenaudioComponent.prototype, "errorEmitter", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('statusEvent')], NgOpenaudioComponent.prototype, "statusEmitter", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "controls", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "visualContainerHeight", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "songData", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "barAmount", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "barGradient", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "backgroundColor", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "accentColor", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "visualStyle", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "current", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "playing", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NgOpenaudioComponent.prototype, "volume", null);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('controlsProgressBar', {
      static: true
    })], NgOpenaudioComponent.prototype, "controlsProgressBar", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('controlsVolumeBar', {
      static: true
    })], NgOpenaudioComponent.prototype, "controlsVolumeBar", void 0);
    NgOpenaudioComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'ng-openaudio',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./ng-openaudio.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./projects/ng-openaudio/src/lib/ng-openaudio.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./ng-openaudio.component.css */
      "./projects/ng-openaudio/src/lib/ng-openaudio.component.css")).default]
  ...
  /***/
  function projectsNgOpenaudioSrcLibNgOpenaudioModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NgOpenaudioModule", function () {
      return NgOpenaudioModule;
    });
    /* harmony import */
    ...
    var _ng_openaudio_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./ng-openaudio.component */
    "./projects/ng-openaudio/src/lib/ng-openaudio.component.ts");
    /* harmony import */
    ...
    var NgOpenaudioModule = function NgOpenaudioModule() {
      _classCallCheck(this, NgOpenaudioModule);
    };

    NgOpenaudioModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function projectsNgOpenaudioSrcPublicApiTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _lib_ng_openaudio_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./lib/ng-openaudio.component */
    "./projects/ng-openaudio/src/lib/ng-openaudio.component.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "NgOpenaudioComponent", function () {
      return _lib_ng_openaudio_component__WEBPACK_IMPORTED_MODULE_1__["NgOpenaudioComponent"];
    });
    /* harmony import */


    var _lib_ng_openaudio_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./lib/ng-openaudio.module */
    "./projects/ng-openaudio/src/lib/ng-openaudio.module.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "NgOpenaudioModule", function () {
      return _lib_ng_openaudio_module__WEBPACK_IMPORTED_MODULE_2__["NgOpenaudioModule"];
    });
    /* harmony import */


    var _lib_models_song_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./lib/models/song-data */
    "./projects/ng-openaudio/src/lib/models/song-data.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "SongData", function () {
      return _lib_models_song_data__WEBPACK_IMPORTED_MODULE_3__["SongData"];
    });
    /* harmony import */


    var _lib_models_equalizer_style__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./lib/models/equalizer-style */
    "./projects/ng-openaudio/src/lib/models/equalizer-style.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "EqualizerStyle", function () {
      return _lib_models_equalizer_style__WEBPACK_IMPORTED_MODULE_4__["EqualizerStyle"];
    });
    /* harmony import */


    var _lib_models_status_event__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./lib/models/status-event */
    "./projects/ng-openaudio/src/lib/models/status-event.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "StatusEvent", function () {
      return _lib_models_status_event__WEBPACK_IMPORTED_MODULE_5__["StatusEvent"];
    });
    /*
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var projects_ng_openaudio_src_public_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! projects/ng-openaudio/src/public-api */
    "./projects/ng-openaudio/src/public-api.ts");
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        key: "loadAudioFile",
        value: function loadAudioFile(event) {
          if (event.type == 'audio/mp3') {
            var s = new projects_ng_openaudio_src_public_api__WEBPACK_IMPORTED_MODULE_2__["SongData"]();
            s.audioSource = URL.createObjectURL(event);
            s.name = event.name; // default image you want
        ...
        key: "loadImageFile",
        value: function loadImageFile(event) {
          var e = event.type.match('^image\/(gif|png|jpeg|jpg)$');
        ...
        key: "changeControls",
        value: function changeControls(checked) {
          this.playerControls = checked;
        }
      }, {
        key: "changePlaying",
        value: function changePlaying(checked) {
          this.playerPlaying = checked;
        }
      }, {
        key: "getVisualStyles",
        value: function getVisualStyles() {
          return Object.keys(projects_ng_openaudio_src_public_api__WEBPACK_IMPORTED_MODULE_2__["EqualizerStyle"]).filter(function (key) {
            return isNaN(Number(projects_ng_openaudio_src_public_api__WEBPACK_IMPORTED_MODULE_2__["EqualizerStyle"][key]));
          });
        }
      }, {
        key: "playDemo",
        ...
        key: "statusEvent",
        value: function statusEvent($event) {
          console.log($event);
        }
      }, {
        key: "errorEvent",
        value: function errorEvent($event) {
          console.log($event);
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var projects_ng_openaudio_src_public_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! projects/ng-openaudio/src/public-api */
    "./projects/ng-openaudio/src/public-api.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], projects_ng_openaudio_src_public_api__WEBPACK_IMPORTED_MODULE_5__["NgOpenaudioModule"]],
      providers: [],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\repo\lib-ng-openaudio\ng-openaudio\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
